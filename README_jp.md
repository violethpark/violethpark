...
> お客様の視点で考え、信頼性の高いシステムを開発するウェブ開発者
...
| 期間 | 会社 | 役割 |
|------|------|------|
| 2024年6月 ~ 現在 | **Hypertech** SW工学部 | 韓国芸術人福祉財団 情報システム維持管理 · 4システム担当 |
| 2022年5月 ~ 2023年11月 | **Pentaworks** SCP研究所 | 新技術PoC · フロントエンドリード · フルスタック開発 |

---

## 📂 主要プロジェクト

- **韓国芸術人福祉財団 情報システム** — Javaマイグレーション、セキュリティ強化、事業対応開発
- **AER (Vue.js)** — MSA/AWSバックエンド設計 + Vue 3フロントエンドリード（チーム規模19名）
- **AER (React)** — Vue → React/Next.jsマイグレーション実施
- **GDC PoC** — Vue.js 3 · TypeScript社内初導入
- **バックオフィスマイグレーション** — vue-cli → Vite、ビルド時間10倍以上短縮

---

## 🎓 学歴 & 資格

- **延世大学校（ソウル）** コンピュータサイエンス学科卒業（2016）
- **情報処理技師** 韓国産業人力公団（2015）
